...
public record ReplayIssueRow(
        ...
        String reviewReason,
        @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd") LocalDate plannedCompletionDate) {
    ...
    public ReplayIssueRow(Long id, String sourceSheet, String groupName, boolean sandbox, int rowOrder,
                          ...
                          String cooperationPersonRealName, String globalSerialNo,
                          ReplayIssueReviewStatus reviewStatus, String reviewerUsername,
                          String reviewerRealName, LocalDateTime reviewedAt, LocalDate plannedCompletionDate) {
        this(id, sourceSheet, groupName, sandbox, rowOrder, domain, sequenceNo, batchNo, transactionCode,
                ...
                cooperationPersonUsername, cooperationPersonRealName, globalSerialNo, reviewStatus,
                reviewerUsername, reviewerRealName, reviewedAt, null, plannedCompletionDate);
    }

    /** Compatibility constructor for callers created before the planned completion date was added. */
    public ReplayIssueRow(Long id, String sourceSheet, String groupName, boolean sandbox, int rowOrder,
                          String domain, String sequenceNo, String batchNo, String transactionCode,
                          String transactionName, String issueLevel, String registeredDate, String fieldName,
                          String issueDescription, String transactionOwner, String issueType,
                          ...
                          String cooperationPersonRealName, String globalSerialNo,
                          ReplayIssueReviewStatus reviewStatus, String reviewerUsername,
                          String reviewerRealName, LocalDateTime reviewedAt) {
        this(id, sourceSheet, groupName, sandbox, rowOrder, domain, sequenceNo, batchNo, transactionCode,
                transactionName, issueLevel, registeredDate, fieldName, issueDescription, transactionOwner,
                issueType, initialAnalysis, finalSolution, resolvedDate, cooperationGroup, resolver, serialNo,
                dataRepairDate, remark, affectedTransactionCount, issueId, issueKey, historicalOccurrenceCount,
                firstOccurrenceDate, lastOccurrenceDate, importedAt, issueStatus, importDate, defectRepairDate,
                cooperationPersonUsername, cooperationPersonRealName, globalSerialNo, reviewStatus,
                reviewerUsername, reviewerRealName, reviewedAt, null, null);
    }

    /** Compatibility constructor for callers created before review fields were added. */
    public ReplayIssueRow(Long id, String sourceSheet, String groupName, boolean sandbox, int rowOrder,
                          String domain, String sequenceNo, String batchNo, String transactionCode,
                          String transactionName, String issueLevel, String registeredDate, String fieldName,
                          String issueDescription, String transactionOwner, String issueType,
        ...
        this(id, sourceSheet, groupName, sandbox, rowOrder, domain, sequenceNo, batchNo, transactionCode,
                ...
                dataRepairDate, remark, affectedTransactionCount, issueId, issueKey, historicalOccurrenceCount,
                firstOccurrenceDate, lastOccurrenceDate, importedAt, issueStatus, importDate, defectRepairDate,
                cooperationPersonUsername, cooperationPersonRealName, globalSerialNo, null, null, null, null, null);
    }
    ...
    public ReplayIssueRow(Long id, String sourceSheet, String groupName, boolean sandbox, int rowOrder,
        ...
        this(id, sourceSheet, groupName, sandbox, rowOrder, domain, sequenceNo, batchNo, transactionCode,
                ...
                dataRepairDate, remark, affectedTransactionCount, issueId, issueKey, historicalOccurrenceCount,
                firstOccurrenceDate, lastOccurrenceDate, importedAt, issueStatus, importDate, defectRepairDate,
                cooperationPersonUsername, cooperationPersonRealName, null, null, null, null, null, null);
    }
